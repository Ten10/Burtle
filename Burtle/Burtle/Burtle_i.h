...
#ifndef __Burtle_i_h__
#define __Burtle_i_h__
...
#ifndef __BurtleProvider_FWD_DEFINED__
#define __BurtleProvider_FWD_DEFINED__

#ifdef __cplusplus
typedef class BurtleProvider BurtleProvider;
#else
typedef struct BurtleProvider BurtleProvider;
#endif /* __cplusplus */

#endif 	/* __BurtleProvider_FWD_DEFINED__ */
...
/* interface __MIDL_itf_Burtle_0000_0000 */
/* [local] */ 
...
extern RPC_IF_HANDLE __MIDL_itf_Burtle_0000_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_Burtle_0000_0000_v0_0_s_ifspec;
...
#ifndef __BurtleLib_LIBRARY_DEFINED__
#define __BurtleLib_LIBRARY_DEFINED__

/* library BurtleLib */
/* [version][uuid] */ 


EXTERN_C const IID LIBID_BurtleLib;

EXTERN_C const CLSID CLSID_BurtleProvider;

#ifdef __cplusplus

class DECLSPEC_UUID("FB586010-A6BA-4921-B921-A4A18ED8A8C1")
BurtleProvider;
#endif
#endif /* __BurtleLib_LIBRARY_DEFINED__ */
